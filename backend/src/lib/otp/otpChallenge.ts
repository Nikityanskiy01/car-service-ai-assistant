...
export async function createOtpChallenge({ userId, purpose, channel, destination, code, token }: any) {
  if (userId) {
...
export async function consumeOtpChallenge(token, code, { purpose }: any = {}) {
