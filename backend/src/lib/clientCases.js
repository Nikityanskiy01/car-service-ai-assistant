...
function computeProgress(kind, requestStatus, consultationStatus, hasBooking) {
  if (kind === 'draft') {
 ...
 * @param {Array<import('@prisma/client').ServiceRequest & { consultationSession?: object | null }>} requests
