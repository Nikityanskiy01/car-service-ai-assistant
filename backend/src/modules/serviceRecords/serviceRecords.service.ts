...
export async function createServiceRecord(clientId, vehicleId, data, { createdById, source = 'client_manual' }: any = {}) {
  await getOwnedVehicle(vehicleId, clientId);
...
export async function findOilHistoryForLookup({ clientId, vehicleId }: any) {
