...
export async function createCategory({ name, description }: any) {
...
export async function createScenario({ title, description }: any) {
...
export async function createQuestion(scenarioId, { text, order }: any) {
...
export async function createHint(scenarioId, { text, order }: any) {
...
export async function createReferenceMaterial({ title, body, categoryId }: any) {
...
export async function updateCategory(id, { name, description }: any) {
...
export async function updateScenario(id, { title, description, active }: any) {
...
export async function updateQuestion(id, { text, order }: any) {
...
export async function updateHint(id, { text, order, scenarioId }: any) {
...
export async function updateReferenceMaterial(id, { title, body, categoryId }: any) {
