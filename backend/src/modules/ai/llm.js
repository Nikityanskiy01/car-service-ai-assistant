...
- Специальный случай "плановое ТО": если пользователь хочет пройти/сделать ТО (техобслуживание), НЕ спрашивай про неисправности и условия проявления. Сразу предложи оформление заявки на ТО и попроси только данные авто (марка, модель, год, пробег), если их не хватает.
