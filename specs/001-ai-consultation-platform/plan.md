...
modular architecture; **PostgreSQL** persistence; OpenAI-compatible LLM module.
Testing: unit, integration, e2e, UI, security,
load.
...
service requests and statuses, administration of scenarios and reference
...
mitigation. LLM reached through a small OpenAI-compatible HTTP adapter.
...
**Constraints**: LLM runs via OpenAI-compatible API; REST
...
| Gate | Status | Notes |
|------|--------|--------|
| Architecture | **Pass** | Client-server, responsive web UI, modular Node (Express), REST, PostgreSQL, cloud LLM |
...
project constitution (modular Node.js, REST, PostgreSQL, OpenAI-compatible LLM).

## Phase 0 & Phase 1 Outputs

- [research.md](./research.md) — стек, модули, доступ к данным, LLM.
...
- [quickstart.md](./quickstart.md) — запуск Express, статика, Prisma, LLM.
